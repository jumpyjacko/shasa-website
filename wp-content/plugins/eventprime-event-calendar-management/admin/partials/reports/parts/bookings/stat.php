...
<ul class="ep-chart-legend ep-mt-3 ep-d-flex">
    <li>
        <div class="ep-chart-legend-stat ep-fs-2"><?php echo esc_html( $ep_functions->ep_price_with_position( $bookings_data->stat->total_revenue ) ); ?></div>
    ...
    <li>
        <div class="ep-chart-legend-stat ep-fs-2"><?php
            ...
            if ( ! empty( $bookings_data->stat->total_revenue ) && ! empty( $bookings_data->stat->days_count ) ) {
                echo esc_html( $ep_functions->ep_price_with_position( $bookings_data->stat->total_revenue / $bookings_data->stat->days_count ) );
            } else {
    ...
    <li>
        <div class="ep-chart-legend-stat ep-fs-2"><?php echo esc_html( $ep_functions->ep_price_with_position( $bookings_data->stat->coupon_discount ) ); ?></div>
