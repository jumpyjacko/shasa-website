...
<?php echo charitable_esc_attr_php( $wrapper ); ?> .column[data-column-id="2"] {
    flex: 1;
    border: 0;
    padding: 2px;
}
...
/* field: progress bar */
<?php echo charitable_esc_attr_php( $wrapper ); ?> .charitable-field.charitable-field-progress-bar {
    margin-top: 10px;
    margin-bottom: 10px;
}
...
<?php echo charitable_esc_attr_php( $wrapper ); ?> .charitable-preview-tab-container .tab-content {
    padding: 0 1px;
}
