        ...
        <tr valign="top" id="ep_settings_card_background" <?php if( $global_options->type_display_view != 'box' && $global_options->type_display_view != 'colored_grid' ) { echo 'style="display:none;"'; } ?>>
            ...
            <td class="forminp forminp-text">
                <?php foreach( $global_options->type_box_color as $key => $color ){?>
                    <input type="text" data-jscolor="{}" name="type_box_color[<?php echo esc_attr($key);?>]" id="performer_box_color_<?php echo esc_attr($key);?>" value="<?php echo esc_attr( $global_options->type_box_color[$key] );?>"><?php
                }?>
