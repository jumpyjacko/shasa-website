                        ...
                        <div class="ep-box-col-12">
                            <div class="ep-feedback-form ep-feedback-form-input-bg">
                                <div class="ep-p-4">
                                    ...
                                    <textarea id="ep-plugin-feedback" name="ep-plugin-feedback-feature_not_available" class="ep-plugin-feedback-textarea ep-box-w-100" rows="2" cols="50"></textarea>
                        ...
                        <div class="ep-box-col-12">
                            <div class="ep-feedback-form ep-feedback-form-input-bg">
                                <div class="ep-p-4">
                                    ...
                                    <textarea id="ep-plugin-feedback" name="ep-plugin-feedback-feature_not_working" class="ep-plugin-feedback-textarea ep-box-w-100" rows="2" cols="50"></textarea>
                                    <div class="ep-pt-1 ep-plugin-feedback-email-check ep-d-flex ep-align-items-center ep-mt-1">
                                        <input type="checkbox" class="ep-my-0 ep-mr-2" id="ep-inform-email" name="ep-inform-email">
                        ...
                        <div class="ep-box-col-12">
                            <div class="ep-feedback-form ep-feedback-form-input-bg">
                                <div class="ep-p-4">
                                    ...
                                    <textarea id="ep-plugin-feedback" name="ep-plugin-feedback-plugin_difficult-to-use" class="ep-plugin-feedback-textarea ep-box-w-100" rows="2" cols="50"></textarea>
                        ...
                        <div class="ep-box-col-12">
                            <div class="ep-feedback-form ep-feedback-form-input-bg">
                                <div class="ep-p-4">
                                    ...
                                    <textarea id="ep-plugin-feedback" name="ep-plugin-feedback-plugin_broke_site" class="ep-plugin-feedback-textarea ep-box-w-100" rows="2" cols="50"></textarea>
                                    <div class="ep-pt-1 ep-plugin-feedback-email-check ep-d-flex ep-align-items-center ep-mt-1">
                                        <input type="checkbox" class="ep-my-0 ep-mr-2" id="ep-inform-email" name="ep-inform-email">
                                    <label for="ep-inform-email" class="ep-text-small">  Also create support ticket </label>
                                    </div>
                        ...
                        <div class="ep-box-col-12">
                            <div class="ep-feedback-form ep-feedback-form-input-bg">
                                <div class="ep-p-4">
                                    ...
                                    <textarea id="ep-plugin-feedback" name="ep-plugin-feedback-plugin_has_design_issue" class="ep-plugin-feedback-textarea ep-box-w-100" rows="2" cols="50"></textarea>
                                    <div class="ep-pt-1 ep-plugin-feedback-email-check ep-d-flex ep-align-items-center ep-mt-1">
                                        <input type="checkbox" class="ep-my-0 ep-mr-2" id="ep-inform-email" name="ep-inform-email">
                                        <label for="ep-inform-email" class="ep-text-small">  Also create support ticket </label>
                                    </div>
                        ...
                        <div class="ep-box-col-12">
                            <div class="ep-feedback-form ep-feedback-form-input-bg">
                                <div class="ep-p-4">
                                    ...
                                    <textarea id="ep-plugin-feedback" name="ep-plugin-feedback-plugin_missing-documentation" class="ep-plugin-feedback-textarea ep-box-w-100" rows="2" cols="50"></textarea>
                                    <div class="ep-pt-1 ep-plugin-feedback-email-check ep-d-flex ep-align-items-center ep-mt-1">
                                            <input type="checkbox" class="ep-my-0 ep-mr-2" id="ep-inform-email" name="ep-inform-email" >
                                            <label for="ep-inform-email" class="ep-text-small">  Also create support ticket </label>
                                    </div>
                        ...
                        <div class="ep-box-col-12">
                            <div class="ep-feedback-form ep-feedback-form-input-bg">
                                <div class="ep-p-4">
                                    ...
                                    <textarea id="ep-plugin-feedback" name="ep-plugin-feedback-other_reasons" class="ep-plugin-feedback-textarea ep-box-w-100" rows="2" cols="50"></textarea>
