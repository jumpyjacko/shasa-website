...
<?php echo charitable_esc_attr_php( $wrapper ); ?> .charitable-field-column:nth-child(even) .charitable-field-text .charitable-campaign-builder-placeholder-preview-text {
	color: white;
}
...
<?php echo charitable_esc_attr_php( $wrapper ); ?> .charitable-field-column:nth-child(even) .charitable-field-section .charitable-field-preview-campaign-summary .campaign-summary-item {
	color: white;
}
