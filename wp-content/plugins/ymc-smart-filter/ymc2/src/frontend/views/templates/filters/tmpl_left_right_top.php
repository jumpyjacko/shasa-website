<?php
/**
 * Template Container: Left Right Top
 */
...
<div class="filter-posts-wrapper">
    ...
    <div class="filter-layout filter-layout--top-left-right<?php echo esc_attr($filter_hidden_class); ?>">
