    ...
    <div class="thickbox-inner">
        ...
        <div class="form-taxonomy">
            <div class="form-item">
                ...
                <span class="description"><?php esc_attr_e('Set a background color for the taxonomy.', 'ymc-smart-filters' ); ?></span>
            ...
            <div class="form-item">
                ...
                <span class="description"><?php esc_attr_e('Set a text color for the taxonomy.', 'ymc-smart-filters' ); ?></span>
            ...
            <div class="form-item">
                ...
                <span class="description"><?php esc_attr_e('Override the default taxonomy name with a custom one.', 'ymc-smart-filters' ); ?></span>
